...
if(t == "ap"){ n = pc._map - 3; b = 90; rt = 1; }
if(t == "evade"){ n = pc._evade + 1; b = 4; rt = 100; }
if(t == "tevade"){ n = pc._evadeTrap + 1; b = 2; rt = 100; }
...
if(t == "str"){ n = pc._physPower - 3; b = 8; rt = 2; }
if(t == "pow"){ n = pc._energyPower - 3; b = 6; rt = 2; }
if(t == "aim"){ n = pc._aim + 1; b = 2; rt = 100; }
if(t == "proc"){ n = pc._proc - 4; b = 3; rt = 100; }
if(t == "procp"){ n = pc._procPower - 99; b = 2; rt = 100; }
